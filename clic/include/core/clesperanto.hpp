...
class Clesperanto
{
  ...
  public:
    ...
    auto BlockEnumerate (const Image &, const Image &, const Image &, const int & = 0) -> void; //! only 1d ? //! do not support IMAGE
    ...
    auto DetectMaximaBox (const Image &, const Image &) -> void;
