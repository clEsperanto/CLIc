 ...
 * @brief Determines the maximum of all pixels in a given image.  It will be stored in a new row of ImageJs Results
 * table in the column 'Max'.
 ...
 * @brief Determines the minimum of all pixels in a given image.  It will be stored in a new row of ImageJs Results
 * table in the column 'Min'.
 ...
 * @brief Determines the minimum intensity in a masked image.  But only in pixels which have non-zero values in another
 * mask image.
...
/**
 * @name opening_sphere
 * @brief Opening operator, sphere-shaped  Applies morphological opening to intensity images using a sphere-shaped
 footprint. This operator also works with binary images.
 * @category 'filter', 'in assistant', 'bia-bob-suggestion'
...
/**
 * @name square
 * @brief Return the element-wise square of the input.  This function is supposed to be similar to its counterpart in
 * numpy [1]
 * @category 'filter'
