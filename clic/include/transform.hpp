 ...
 * @return std::tuple<size_t, size_t, size_t, cle::TransformMatrix>
 */
auto
prepare_output_shape_and_transform(const cle::Array::Pointer & src, const cle::TransformMatrix & transform)
