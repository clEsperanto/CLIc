                                      ...
                                      float                   max_distance) -> Array::Pointer
{
    ...
    auto above_min_distance = tier1::greater_or_equal_constant_func(distance_matrix, nullptr, min_distance)
    auto below_max_distance = tier1::smaller_or_equal_constant_func(distance_matrix, nullptr, max_distance)
