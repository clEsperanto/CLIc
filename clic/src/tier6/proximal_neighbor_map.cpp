                                 ...
                                 float                   max_distance) -> Array::Pointer
{
  ...
  auto nb_touching_neighbors = tier5::proximal_neighbor_count(labels, nullptr, max_distance, min_distance)
    tier1::replace_intensities_func(labels, nb_touching_neighbors, dst) return dst
}
