...
auto
maximum_image_and_scalar_func(const Device::Pointer & device, const Array::Pointer & src, Array::Pointer dst, float scalar) -> Array::Pointer
{
  return apply_binary_math_operation(device, src, dst, scalar, "fmax(x, y)");
}

auto
minimum_image_and_scalar_func(const Device::Pointer & device, const Array::Pointer & src, Array::Pointer dst, float scalar) -> Array::Pointer
{
...
auto
subtract_scalar_from_image_func(const Device::Pointer & device, const Array::Pointer & src, Array::Pointer dst, float scalar) -> Array::Pointer
{
  return apply_binary_math_operation(device, src, dst, scalar, "(x - y)");
}

auto
subtract_image_from_scalar_func(const Device::Pointer & device, const Array::Pointer & src, Array::Pointer dst, float scalar) -> Array::Pointer
{
...
auto
multiply_image_and_scalar_func(const Device::Pointer & device, const Array::Pointer & src, Array::Pointer dst, float scalar) -> Array::Pointer
{
  return apply_binary_math_operation(device, src, dst, scalar, "(x * y)");
}
...
auto
greater_or_equal_constant_func(const Device::Pointer & device, const Array::Pointer & src, Array::Pointer dst, float scalar) -> Array::Pointer
{
  return apply_binary_math_operation(device, src, dst, scalar, "(x >= y ? 1.0f : 0.0f)");
}
...
auto
smaller_or_equal_constant_func(const Device::Pointer & device, const Array::Pointer & src, Array::Pointer dst, float scalar) -> Array::Pointer
{
  return apply_binary_math_operation(device, src, dst, scalar, "(x <= y ? 1.0f : 0.0f)");
}
