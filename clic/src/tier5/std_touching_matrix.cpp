...
auto
standard_deviation_partial_touching_area_matrix_func(const Device::Pointer & device, const Array::Pointer & src_label, Array::Pointer dst_vector) -> Array::Pointer
{
...
auto
standard_deviation_touch_portion_func(const Device::Pointer & device, const Array::Pointer & src_label, Array::Pointer dst_vector) -> Array::Pointer
{
