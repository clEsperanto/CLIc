...
auto
coordinate_generator(int   width,
                     int   height,
                     int   depth,
                     float delta_x,
                     float delta_y,
                     ...
                     float sigma_x,
                     float sigma_y,
                     float sigma_z) -> std::tuple<std::vector<float>, std::vector<float>, std::vector<float>>
{
                       ...
                       float                   sigma_z) -> Array::Pointer
{
  ...
  auto [all_x_coords, all_y_coords, all_z_coords] =
    coordinate_generator(width, height, depth, delta_x, delta_y, delta_z, sigma_x, sigma_y, sigma_z);
