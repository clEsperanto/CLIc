               ...
               float                   maximum_intensity) -> Array::Pointer
{
  ...
  auto   partial_hist = Array::create(num_bins, 1, number_of_partial_histograms, 3, dType::INDEX, src->mtype(), src->device());
  ...
  const ParameterList params = {
    { "src", src },       { "dst", partial_hist }, { "minimum", minimum_intensity }, { "maximum", maximum_intensity }, { "step_size_x", 1 },
    { "step_size_y", 1 }, { "step_size_z", 1 }
  };
