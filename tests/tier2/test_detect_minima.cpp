...
protected:
  ...
  std::array<uint8_t, 5 * 5 * 1> input_bound = { 1,   100, 8,   100, 2,   100, 100, 100, 100, 100, 3,   100, 4,
                                                 100, 5,   100, 100, 100, 100, 100, 6,   100, 7,   100, 9 };

  std::array<uint8_t, 5 * 5 * 1> valid_bound = { 1, 0, 1, 0, 1, 0, 0, 0, 0, 0, 1, 0, 1, 0, 1, 0, 0, 0, 0, 0, 1, 0, 1, 0, 1 };
};
