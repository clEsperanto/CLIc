...
main(int argc, char ** argv) -> int
{
  ...
  //  if (!run_test<signed short>({ 3, 1, 1 }, cle::IMAGE)) { return EXIT_FAILURE; }
  ...
  //  if (!run_test<signed short>({ 3, 3, 1 }, cle::IMAGE)) { return EXIT_FAILURE; }
  ...
  //  if (!run_test<signed short>({ 3, 3, 3 }, cle::IMAGE)) { return EXIT_FAILURE; }
