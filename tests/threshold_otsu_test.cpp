...
main(int argc, char ** argv) -> int
{
  ...
  //  if (!run_test<signed short>({ 12, 1, 1 }, cle::IMAGE)) { return EXIT_FAILURE; }
  ...
  //  if (!run_test<signed short>({ 6, 2, 1 }, cle::IMAGE)) { return EXIT_FAILURE; }
  ...
  //  if (!run_test<signed short>({ 3, 2, 2 }, cle::IMAGE)) { return EXIT_FAILURE; }
