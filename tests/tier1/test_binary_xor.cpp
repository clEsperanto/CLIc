...
class TestBinaryXOR : public ::testing::TestWithParam<std::string>
{
protected:
...
INSTANTIATE_TEST_SUITE_P(InstantiationName, TestBinaryXOR, ::testing::ValuesIn(getParameters()));
