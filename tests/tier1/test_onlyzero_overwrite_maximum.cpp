...
protected:
  ...
  std::array<float, 5 * 5 * 2> valid_box = { 1, 2, 3, 3, 3, 2, 1, 2, 3, 4, 4, 2, 3, 4, 5, 4, 4, 4, 5, 5, 4, 4, 5, 5, 5,
                                             1, 2, 3, 3, 3, 2, 3, 4, 4, 4, 4, 4, 5, 5, 5, 4, 4, 5, 5, 5, 4, 4, 5, 5, 5 };

  std::array<float, 5 * 5 * 2> valid_sphere = { 0, 1, 2, 3, 0, 1, 1, 2, 3, 3, 2, 2, 3, 4, 4, 4, 4, 4, 5, 5, 0, 4, 4, 5, 0,
