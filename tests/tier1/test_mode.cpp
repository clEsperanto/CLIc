...
TEST_P(TestMode, executeBox)
{
  ...
  auto gpu_input = cle::Array::create(6, 6, 1, cle::dType::UINT8, cle::mType::BUFFER, device);
...
INSTANTIATE_TEST_CASE_P(InstantiationName, TestMode, ::testing::ValuesIn(getParameters()));
