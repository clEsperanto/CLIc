...
class TestNotEqual : public ::testing::TestWithParam<std::string>
{
protected:
...
INSTANTIATE_TEST_SUITE_P(InstantiationName, TestNotEqual, ::testing::ValuesIn(getParameters()));
