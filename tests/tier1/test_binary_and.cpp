...
class TestBinaryAND : public ::testing::TestWithParam<std::string>
{
protected:
...
INSTANTIATE_TEST_SUITE_P(InstantiationName, TestBinaryAND, ::testing::ValuesIn(getParameters()));
