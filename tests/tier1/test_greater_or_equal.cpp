...
class TestGreaterEqual : public ::testing::TestWithParam<std::string>
{
protected:
...
TEST_P(TestGreaterEqual, execute)
{
...
INSTANTIATE_TEST_SUITE_P(InstantiationName, TestGreaterEqual, ::testing::ValuesIn(getParameters()));
