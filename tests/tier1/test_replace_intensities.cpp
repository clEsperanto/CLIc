...
TEST_P(TestReplaceIntensities, execute)
{
  ...
  auto gpu_input2 = cle::Array::create(10, 1, 1, cle::dType::FLOAT, cle::mType::BUFFER, device);
...
INSTANTIATE_TEST_CASE_P(InstantiationName, TestReplaceIntensities, ::testing::ValuesIn(getParameters()));
