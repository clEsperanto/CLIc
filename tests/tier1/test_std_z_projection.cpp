...
protected:
  ...
  std::array<float, 5 * 5 * 5> input = {
    1, 0, 0, 0,  9, 0, 2, 0,  8, 0, 3,  0, 1, 0, 10, 0, 4, 0,  7,  0, 5, 0, 6, 0, 10, 0, 2, 0,  8, 0, 1,  0,
    0, 0, 9, 3,  0, 1, 0, 10, 0, 4, 0,  7, 0, 5, 0,  6, 0, 10, 0,  2, 0, 8, 0, 3, 0,  1, 0, 10, 0, 4, 0,  7,
    0, 1, 0, 0,  0, 9, 5, 0,  6, 0, 10, 0, 2, 0, 8,  0, 1, 0,  0,  0, 9, 0, 4, 0, 7,  0, 3, 0,  1, 0, 10, 5,
    0, 6, 0, 10, 1, 0, 0, 0,  9, 0, 4,  0, 7, 0, 3,  0, 1, 0,  10, 0, 2, 0, 8, 0, 5,  0, 6, 0,  10
  };
...
TEST_P(TestStdProjectionZ, execute)
{
  ...
  auto gpu_input = cle::Array::create(5, 5, 5, cle::dType::FLOAT, cle::mType::BUFFER, device);
