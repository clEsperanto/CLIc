...
class TestEqual : public ::testing::TestWithParam<std::string>
{
protected:
...
INSTANTIATE_TEST_SUITE_P(InstantiationName, TestEqual, ::testing::ValuesIn(getParameters()));
