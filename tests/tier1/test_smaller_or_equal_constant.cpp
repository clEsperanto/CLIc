...
class TestSmallerEqualConstant : public ::testing::TestWithParam<std::string>
{
protected:
...
TEST_P(TestSmallerEqualConstant, execute)
{
...
INSTANTIATE_TEST_SUITE_P(InstantiationName, TestSmallerEqualConstant, ::testing::ValuesIn(getParameters()));
