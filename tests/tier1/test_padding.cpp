...
TEST_P(TestPadding, executePadding)
{
  ...
  auto gpu_pad = cle::tier1::pad_func(device, gpu_input, nullptr, 6, 5, 0, 5, false);
...
TEST_P(TestPadding, executePaddingCenter)
{
  ...
  auto gpu_pad = cle::tier1::pad_func(device, gpu_input, nullptr, 6, 5, 0, 5, true);
