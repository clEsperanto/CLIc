...
class TestSmaller : public ::testing::TestWithParam<std::string>
{
protected:
...
INSTANTIATE_TEST_SUITE_P(InstantiationName, TestSmaller, ::testing::ValuesIn(getParameters()));
