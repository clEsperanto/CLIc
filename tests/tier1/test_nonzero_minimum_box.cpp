...
class TestNonzeroMinimumBox : public ::testing::TestWithParam<std::string>
{
protected:
...
TEST_P(TestNonzeroMinimumBox, execute)
{
...
INSTANTIATE_TEST_CASE_P(InstantiationName, TestNonzeroMinimumBox, ::testing::ValuesIn(getParameters()));
