...
class TestGreaterConstant : public ::testing::TestWithParam<std::string>
{
protected:
...
TEST_P(TestGreaterConstant, execute)
{
...
INSTANTIATE_TEST_SUITE_P(InstantiationName, TestGreaterConstant, ::testing::ValuesIn(getParameters()));
