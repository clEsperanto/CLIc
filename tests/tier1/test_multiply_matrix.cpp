...
TEST_P(TestMultiplyMatrix, execute)
{
  ...
  auto gpu_input1 = cle::Array::create(3, 4, 1, cle::dType::FLOAT, cle::mType::BUFFER, device);
  auto gpu_input2 = cle::Array::create(3, 3, 1, cle::dType::FLOAT, cle::mType::BUFFER, device);
