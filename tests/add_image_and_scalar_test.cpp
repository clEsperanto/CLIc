...
template <class type>
std::vector<type>
run_kernel_with_buffer (std::vector<type> &arr_1, std::array<size_t, 3> &shape, type scalar)
{
    cle::Clesperanto cle;
...
template <class type>
std::vector<type>
run_kernel_with_image (std::vector<type> &arr_1, std::array<size_t, 3> &shape, type scalar)
{
    cle::Clesperanto cle;
    cle.GetDevice ()->WaitForKernelToFinish ();
