...
main(int argc, char ** argv) -> int
{
  ...
  // if (!run_test<float> ({ 5, 3, 1 }, CL_MEM_OBJECT_BUFFER)) return EXIT_FAILURE;
  // if (!run_test<int> ({ 5, 3, 1 }, CL_MEM_OBJECT_BUFFER)) return EXIT_FAILURE;
  // if (!run_test<unsigned int> ({ 5, 3, 1 }, CL_MEM_OBJECT_BUFFER)) return EXIT_FAILURE;
  // if (!run_test<short> ({ 5, 3, 1 }, CL_MEM_OBJECT_BUFFER)) return EXIT_FAILURE;
  // if (!run_test<unsigned short> ({ 5, 3, 1 }, CL_MEM_OBJECT_BUFFER)) return EXIT_FAILURE;
  // if (!run_test<char> ({ 5, 3, 1 }, CL_MEM_OBJECT_BUFFER)) return EXIT_FAILURE;
  // if (!run_test<unsigned char> ({ 5, 3, 1 }, CL_MEM_OBJECT_BUFFER)) return EXIT_FAILURE;
  ...
  // if (!run_test<float> ({ 5, 1, 1 }, CL_MEM_OBJECT_IMAGE1D)) return EXIT_FAILURE;
  ...
  // if (!run_test<float> ({ 5, 3, 1 }, CL_MEM_OBJECT_IMAGE1D)) return EXIT_FAILURE;
