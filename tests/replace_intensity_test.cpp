...
template <class type>
std::array<size_t, 3>
generate_data (std::vector<type> &arr_1, std::vector<type> &valid, size_t width, size_t height, size_t depth, float scalar_1, float scalar_2)
{
...
template <class type>
std::vector<type>
run_kernel_with_buffer (std::vector<type> &arr, std::array<size_t, 3> &shape, float scalar_1, float scalar_2)
{
    cle::Clesperanto cle;
...
template <class type>
std::vector<type>
run_kernel_with_image (std::vector<type> &arr, std::array<size_t, 3> &shape, float scalar_1, float scalar_2)
{
    cle::Clesperanto cle;
    cle.GetDevice ()->WaitForKernelToFinish ();
