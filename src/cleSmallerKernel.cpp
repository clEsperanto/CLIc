...
void SmallerKernel::DefineDimensionality()
{
    std::string dim = "_2d";
...
void SmallerKernel::SetInput1(Object& x)
{
    this->AddObject(&x, "src1");
}

void SmallerKernel::SetInput2(Object& x)
{
    this->AddObject(&x, "src2");
}

void SmallerKernel::SetOutput(Object& x)
{
